  ...
  return (
    <div className="flex flex-col gap-6">
      <div className="flex items-center justify-between border-b border-[#EDEEF2] pb-5">
        <h1 className="text-[28px] leading-[100%] font-semibold text-[#2B3043]">Kateqoriyalar</h1>
        <Button
            ...
            <TableBody>
              ...
              {pageItems.map((category, index) => (
                <TableRow key={category.id} className="border-neutral-100">
                  ...
                  <TableCell className="max-w-[220px] truncate px-4 py-4 text-[15px] leading-[100%] font-medium text-[#2B3043]">
                    {category.name}
                  </TableCell>
